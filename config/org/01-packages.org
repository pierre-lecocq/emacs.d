...
Define the wanted packages that will be installed automatically.
...
Define the function that will install the wanted packages thanks to the chosen package manager.
